...
import sys
sys.path.insert(0, 'E:/research/deep-conditional-distribution-regression-master/experiments')
...
loss_model_list = ['multi-binary', 'multi-class', 'multi-binary-gaussian']
sim_iter = 3
target_dir = 'E:/research/deep-conditional-distribution-regression-master/experiments'
